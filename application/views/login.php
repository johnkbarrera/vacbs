...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url()."public/"; ?>plugins/iCheck/square/green.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Vac</b>BS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>auth/login" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Usuario" name="f_usuario">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Contraseña" name="f_contrasenna">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox"> no olvidar
            </label>
          </div>
        </div>
        <!-- /.col -->
