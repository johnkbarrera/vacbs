<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper" style="background-color:#ffffff">
      ...
      <div class="jumbotron" style="background-color:#ffffff">
        <div class="container">
          <br>
          <h1 class="display-3">Gestión Inteligente de la Producción Lechera a tu Alcance!</h1>
          <p>Más de 800.000 ganaderos en todo el Perú confían en nosotros.</p>
          <br>
          <p><a class="btn btn-success btn-lg" href="#" role="button">Descarga VacBs Movíl aqui! &raquo;</a></p>
        </div>
      </div>

      <div class="jumbotron" style="background-color:#EDFFE2" > <!-- style="background-color:#96D894" -->
        <div class="container">
      ...
      <div class="jumbotron" style="background-color:#ffffff" > <!-- style="background-color:#96D894" -->
        <div class="container">
          <!-- Example row of columns -->
          <h2>Instituciones patrocinadoras</h2>
          <div class="row">
            <div class="col-md-4">

              <div class="description-block border-right" style="height: 200px;">
                <br>
                <span class="description-percentage text-green">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/INIA.svg/200px-INIA.svg.png" alt="User Image">
                </span>
                <br>
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="description-block border-right" style="height: 200px;">
                <span class="description-percentage text-green">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/UPacifico.png/190px-UPacifico.png" alt="User Image">
                </span>
                <br>
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="description-block border-right" style="height: 200px;">
                <span class="description-percentage text-green">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Unalm_logo.png/160px-Unalm_logo.png" alt="User Image">
                </span>
                <br>
              </div>
